...
//                             <button
//                                 key={tab}
//                                 className={`px-3 py-2 md:px-4 md:py-2 font-semibold text-sm md:text-base ${activeTab === tab
//                                     ? 'text-[#A5487D] border-b-2 border-[#A5487D]'
//                                     : 'text-gray-500 hover:text-gray-700'
//                                     } mb-2`}
//                                 onClick={() => handleTabClick(tab)}
...
//                                         onClick={() => toggleFaq(0)}
//                                     >
//                                         1. What causes skin allergies, and can they be treated?
//                                         <span className="text-2xl">{faqOpen[0] ? '-' : '+'}</span>
//                                     </button>
//                                     {faqOpen[0] && (
//                                         <div className="p-3 md:p-4 text-sm md:text-base">
//                                             <p className="text-gray-700">Skin allergies can be caused by various factors, including contact with allergens such as cosmetic products, foods, dust, or pollen. Treatment often involves identifying and avoiding the allergen, as well as using topical creams or antihistamines to relieve symptoms.</p>
//                                         </div>
//                                     )}
//                                 </div>
...
//                                         onClick={() => toggleFaq(1)}
//                                     >
//                                         2. How can I prevent acne breakouts?
//                                         <span className="text-2xl">{faqOpen[1] ? '-' : '+'}</span>
//                                     </button>
//                                     {faqOpen[1] && (
//                                         <div className="p-3 md:p-4 text-sm md:text-base">
//                                             <p className="text-gray-700">Preventing acne breakouts involves maintaining good skincare habits, such as cleansing the skin regularly, using non-comedogenic products, and avoiding excessive scrubbing or picking at blemishes. Additionally, a balanced diet, stress management, and staying hydrated can contribute to clearer skin.</p>
//                                         </div>
//                                     )}
//                                 </div>
...
//                                         onClick={() => toggleFaq(2)}
//                                     >
//                                         3. What are the key benefits of homeopathic treatment for skin conditions?
//                                         <span className="text-2xl">{faqOpen[2] ? '-' : '+'}</span>
//                                     </button>
//                                     {faqOpen[2] && (
//                                         <div className="p-3 md:p-4 text-sm md:text-base">
//                                             <p className="text-gray-700">Key benefits of homeopathic treatment for skin conditions include a holistic approach that addresses the root cause of the issue, the use of safe and natural remedies, minimal side effects, and a focus on boosting the body's immunity for long-term relief.</p>
//                                         </div>
//                                     )}
//                                 </div>
//                             </div>
...
//             {/* Right Section: Contact Form */}
//             <div className="bg-white rounded-lg shadow-md p-4 md:p-6 border-2 border-pink-200">
...
//                             type="text"
//                             id="fullName"
//                             className="shadow appearance-none border rounded w-full py-1 md:py-2 px-2 md:px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm"
//                             placeholder="Full Name"
//                         />
//                     </div>
//                     {/* Phone Number Input */}
...
//                             <select
//                                 id="countryCode"
//                                 className="shadow appearance-none border rounded py-1 md:py-2 px-2 md:px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mr-2 text-sm"
//                             >
...
//                     </div>
//                     <button
//                         className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-1 md:py-2 px-3 md:px-4 rounded focus:outline-none focus:shadow-outline w-full text-sm"
//                         type="button"
//                     >
//                         Book an appointment
//                     </button>
