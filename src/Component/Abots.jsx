...
//                             balance, hormonal harmony, and the body's natural healing ability.
//                             Great care and personalized treatment ensure that everything we do
...
//                             health, immune function, and lifestyle impact. We also incorporate
//                             the best natural remedies for treating chronic and acute conditions
//                             with precision. Dr. Princy is a strong advocate for gentle,
//                             effective healing, ensuring minimal side effects and long-lasting
//                             wellness.
//                         </p>
//                     </div>
...
//                         />
//                         <button className="absolute top-5 right-75  bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
//                             Book An Appointment
//                         </button>
//                     </div>
//                 </div>
...
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
//                     {/* Image */}
//                     <div className="relative"> {/* Ensure image takes full width */}
//                         <img
//                             src={d4}
//                             alt="Dr. Princy"
//                             className="rounded-lg shadow-md  object-cover object-center w-auto  h-auto"
//                         />
//                     </div>
...
//                             Clinic, offering natural and holistic treatments for a wide range of
//                             health conditions. With extensive experience in homeopathy, she
...
//             <div
//       className="container mx-auto px-6 py-20 rounded-3xl flex items-center shadow-md relative overflow-hidden bg-[#A5487DCC] opcity-20"
//     //   style={{ backgroundColor: '#C77399' }} // Set background color here
//     >
//       {/* Background Image */}
//       <div className="absolute inset-0 opacity-20"> {/* Adjust opacity as needed */}
//         <img
//           src={d5}
//           alt=""
...
//         <div>
//           <button
//             className="bg-white text-[#C77399] font-bold py-2 px-6 rounded-full hover:bg-gray-100 hover:text-[#A5487D]"
//           >
//             Book Consultation
//           </button>
//         </div>
